...
global.channelLink = "https://whatsapp.com/channel/0029Vb87xXC7z4knimhaAE3f";
global.ytch = "ETHICALMUU";
    ...
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb87xXC7z4knimhaAE3f' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/HRo7GsirzbpKfRY5nHRc43?mode=hqrt3` 
                }, { quoted: message });
                return;
            }
        }
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                isSenderAdmin = badwordAdminStatus.isSenderAdmin;
                isBotAdmin = badwordAdminStatus.isBotAdmin;
                if (!isBotAdmin) {
            ...
            case userMessage.startsWith('.translate') || userMessage.startsWith('.trt'):
                const trLength = userMessage.startsWith('.translate') ? 10 : 4;
                await handleTranslateCommand(sock, chatId, message, userMessage.slice(trLength));
                return;
